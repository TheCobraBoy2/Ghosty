...
function Bridge.__index(bridges, bridgeName)
    ...
    local executablePath = Bridge.Ghosty.Bridges:FindFirstChild(executableName)
...
function Bridge.new()
    ...
    if (executableName ~= nil and executableName ~= script.Name) then
        executablePath = Bridge.Ghosty.Bridges:FindFirstChild(executableName)

        if (executablePath == nil) then
            executablePath = Instance.new('Folder', Bridge.Ghosty.Bridges)
